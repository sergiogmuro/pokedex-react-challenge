...
const validationSchema = Yup.object({
    ...
    pokemonB: Yup.number()
        .nullable()
        .required('Select a Pokémon.')
        .test('different-pokemon', 'You cannot compare the same Pokémon.', function (value) {
            return value !== this.parent.pokemonA;
        })
});

export function CompareForm({onCompare, isChangedHandler}) {
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            if (values.pokemonA !== null && values.pokemonB !== null && values.pokemonA !== values.pokemonB) {
    ...
    useEffect(() => {
        ...
        if (pokemonA !== null && pokemonB !== null && pokemonA !== pokemonB) {
    ...
    return <form className={styles.form} onSubmit={formik.handleSubmit}>
        <div className={styles.selectors}>
            <PokemonSelector
                ...
                error={formik.touched.pokemonA ? formik.errors.pokemonA : undefined}
            />
            ...
            <PokemonSelector
                ...
                error={formik.touched.pokemonB ? formik.errors.pokemonB : undefined}
            />
        </div>
