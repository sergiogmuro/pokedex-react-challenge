  ...
  return (
      <main className={styles.container}>
        <PageHeader
            ...
            description={
              pokemonIds.length > 1
                  ? "Mantén presionado el icono para reorganizar tu equipo."
                  : undefined
            }
        ...
        {pokemonIds.length === 0 ? (
            <section className={styles.empty}>
              ...
              <p>Add up to 6 Pokémon from the Pokédex to build your team.</p>
              <Link to="/pokemon" className={styles.button}>
                Explore Pokémon
              </Link>
            </section>
        ) : (
            ...
            >
              <SortableContext items={pokemonIds} strategy={horizontalListSortingStrategy}>
                <section className={styles.grid} aria-label="Your Pokémon team">
